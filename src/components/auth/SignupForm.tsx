    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-8 py-6">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-6">
          <h1 className="text-3xl font-light text-gray-900 mb-1 tracking-tight">Create account</h1>
          <p className="text-gray-500 text-sm font-light">Get started on your journey</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 mb-5 font-light">
          ...
          <Link href="/login" className="text-gray-700 hover:text-gray-900 font-medium transition-colors duration-200">
            Sign in
          </Link>
        </p>
